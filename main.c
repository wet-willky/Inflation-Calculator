...
start:
	...
	if (amount1 < 0)
	{
		printf("error, negative number: %.2f\n\n\n", amount1);
		goto start;
	}
	...
	//restarts program if year is greater than 2025.
	if (year2 >= 2025)
	{
		printf("Invalid Years Input Different Years.\n\n\n");
		goto start;
	...
	//restarts program unless the years have at least one year apart and non negative. 
	if (year2 - year1 < 0)
	{
		printf("Invalid Years Input Different Years.\n\n\n");
		goto start;
